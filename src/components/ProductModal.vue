      ...
      <div class="relative">
        ...
        <div class="p-6">
          <div class="flex flex-col md:flex-row gap-6">
            ...
            <div class="md:w-1/2">
              <h2 class="text-2xl font-bold mb-2">{{ product.name_en }}</h2>
              <p class="text-xl text-gray-600 mb-4">{{ product.name_kh }}</p>
              ...
              <!-- <div class="bg-gray-50 p-4 rounded-lg">
                ...
                <p class="text-sm text-gray-500">
                  Until: {{ new Date(product.end_date).toLocaleDateString() }}
                </p>
              </div> -->
            </div>
          </div>
          ...
          <div v-if="relatedProducts.length > 0" class="mt-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              ...
              >
                ...
                <h4 class="font-semibold">{{ related.name_en }}</h4>
                <!-- <p class="text-green-600">${{ related.price.toFixed(2) }}</p> -->
                <p class="text-green-600">${{ related.price }}</p>
              </div>
            </div>
          </div>
        </div>
